    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_Calcular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmb_E1.SelectedItem.ToString() == "Gerente" && cmb_E2.SelectedItem.ToString() == "Secretaria" && cmb_E3.SelectedItem.ToString() == "Asistente")
                {
                ...
                else
                {
                    if (Convert.ToInt32(txb_HE1.Text) > 0 && Convert.ToInt32(txb_HE2.Text) > 0 && Convert.ToInt32(txb_HE3.Text) > 0)
                    {
                        ...
                        MessageBox.Show("El empleado "+Ne1+" "+Ae1+" con sueldo bruto de $"+sb1+" con descuento de afp $"+ (afp * sb1) + " ISSS $"+ (isss * sb1) + " y renta $"+ (renta * sl1) + " tiene un sueldo liquido de $"+sl1+"");
                    }
                }
            }
