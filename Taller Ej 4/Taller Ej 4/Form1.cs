    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_Calcular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double sb1 = 0, sb3 = 0, sb2 = 0, isss = 0.00525, afp = 0.00688, renta = 0.01, sl1 = 0, sl2 = 0, sl3 = 0, bono1 = 0, bono2 = 0, bono3 = 0, sln1 = 0, sln2 = 0, sln3 = 0;
                ...
                if (cmb_E1.SelectedItem.ToString() == "Gerente" && cmb_E2.SelectedItem.ToString() == "Asistente" && cmb_E3.SelectedItem.ToString() == "Secretaria")
                {
                    if (Convert.ToInt32(txb_HE1.Text) > 0 && Convert.ToInt32(txb_HE2.Text) > 0 && Convert.ToInt32(txb_HE3.Text) > 0)
                    {
                        ...
                        sln1 = ((-isss * sb1) - (afp * sb1) - (renta * sb1) + sb1);


                        sln3 = ((-isss * sb3) - (afp * sb3) - (renta * sb3) + sb3);


                        sln2 = ((-isss * sb2) - (afp * sb2) - (renta * sb2) + sb2);

                        MessageBox.Show("No hay bono");
                        MessageBox.Show("El empleado " + Ne1 + " " + Ae1 + " con sueldo bruto de $" + sb1 + " con descuento de afp $" + Math.Round(afp * sb1, 2) + " ISSS $" + Math.Round(isss * sb1, 2) + " y renta $" + Math.Round(renta * sb1, 2) + " tiene un sueldo liquido de $" + Math.Round(sln1, 2) + "");
                        MessageBox.Show("El empleado " + Ne2 + " " + Ae2 + " con sueldo bruto de $" + sb2 + " con descuento de afp $" + Math.Round(afp * sb2, 2) + " ISSS $" + Math.Round(isss * sb2, 2) + " y renta $" + Math.Round(renta * sb2, 2) + " tiene un sueldo liquido de $" + Math.Round(sln2, 2) + "");
                        MessageBox.Show("El empleado " + Ne3 + " " + Ae3 + " con sueldo bruto de $" + sb3 + " con descuento de afp $" + Math.Round(afp * sb3, 2) + " ISSS $" + Math.Round(isss * sb3, 2) + " y renta $" + Math.Round(renta * sb3, 2) + " tiene un sueldo liquido de $" + Math.Round(sln3, 2) + "");

                        if (sln1 < sln2)
                        {
                            if (sln2 < sln3)
                            {
                                MessageBox.Show("" + Ne3 + " " + Ae3 + " tiene el sueldo liquido mas alto");
                            }
                            else
                                MessageBox.Show("" + Ne2 + " " + Ae2 + " tiene el sueldo liquido mas alto");
                        }
                        else if (sln1 > sln2)
                        {
                            if (sln1 < sln3)
                            {
                                ...
                                MessageBox.Show("" + Ne1 + " " + Ae1 + " tiene el sueldo liquido mas alto");
                        }

                        if (sl1 < sl2 && sl1 < sl3)
                        {
                            MessageBox.Show("" + Ne1 + " " + Ae1 + " tiene el sueldo liquido mas bajo");
                        }
                        else
                        {
                            if (sl2 < sl1 && sl2 < sl3)
                            {
                                MessageBox.Show("" + Ne2 + " " + Ae2 + " tiene el sueldo liquido mas bajo");
                            }
                            else
                            {
                                MessageBox.Show("" + Ne3 + " " + Ae3 + " tiene el sueldo liquido mas bajo");
                            }
                        }
                ...
                else
                {
                    if (Convert.ToInt32(txb_HE1.Text) > 0 && Convert.ToInt32(txb_HE2.Text) > 0 && Convert.ToInt32(txb_HE3.Text) > 0)
                    {
                        ...
                        sl1 = (-((isss * sb1) + (afp * sb1) + (renta * sb1)) + sb1);
                        sl1 = Math.Round((sl1 * bono1) + sl1, 2);

                        sl3 = (-((isss * sb3) + (afp * sb3) + (renta * sb3)) + sb3);
                        sl3 = Math.Round((sl3 * bono1) + sl3, 2);

                        sl2 = (-((isss * sb2) + (afp * sb2) + (renta * sb2)) + sb2);
